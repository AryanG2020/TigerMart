...
import com.example.tigermartdepauw.adapters.MyCartAdapter;
import com.example.tigermartdepauw.models.MyCartModel;
...
public class cartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("totalPrice", overAllTotalAmount); // directly pass the calculated total amount
    ...
    public BroadcastReceiver mMessageReceiver= new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            double totalCost=intent.getDoubleExtra("totalAmount", 0);
            overAllTotalAmount=totalCost;

            overAllAmount.setText("Total Amount: "+totalCost+ "$");
        }
    };
    ...
    private void deleteAllCartItems() {
        // Corrected path to the user's cart items sub-collection
        final CollectionReference cartCollectionRef = firestore.collection("AddToCart")
        ...
        cartCollectionRef.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    // Clear the local list and update UI after all deletions
                    cartModelList.clear();
                    cartAdapter.notifyDataSetChanged();
                    overAllAmount.setText("Total Amount: $0");
                } else {

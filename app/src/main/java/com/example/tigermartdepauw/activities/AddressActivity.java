...
import com.example.tigermartdepauw.adapters.AddressAdapter;
import com.example.tigermartdepauw.models.AddressModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*paymentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                amount = getIntent().getDoubleExtra("totalPrice", 20.0);
        ...
        paymentButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                double amount = getIntent().getDoubleExtra("totalPrice", 0.0); // Correct key and default
